...
const serviceAccount = {
  ...
  project_id: process.env.FIREBASE_PROJECT_ID || 'studio-7642357109-d9026',
...
admin.initializeApp({
  ...
  storageBucket: process.env.FIREBASE_STORAGE_BUCKET || 'studio-7642357109-d9026.firebasestorage.app'
});

const bucket = admin.storage().bucket();
const STORAGE_BUCKET = 'studio-7642357109-d9026.firebasestorage.app';
