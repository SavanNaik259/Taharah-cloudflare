...
.featured-collection-header2 .section-title {
  ...
  <body style="margin: 0;">
    ...
    <script>
        ...
        // Fast hide: Hide as soon as the main structure is ready
        // This prevents waiting for heavy videos and 100+ product images
        ...
        // Safety timeout: Never show loader for more than 1.5 seconds
        // Most users won't wait longer than this anyway
        setTimeout(hideLoader, 1500);

        // Window load is the "slow" way (waits for everything), 
        // we keep it as a final fallback
